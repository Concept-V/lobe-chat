...
ns.add_resource(Entity, '/get_entity', endpoint='get_entity')
ns.add_resource(Relation, '/get_relation', endpoint='get_relation')
ns.add_resource(Observation, '/get_observation', endpoint='get_observation')
ns.add_resource(OpenNodes, '/open_nodes', endpoint='open_nodes')
ns.add_resource(SearchNodes, '/search_nodes', endpoint='search_nodes')
ns.add_resource(ReadGraph, '/read_graph', endpoint='read_graph')
...
ns.add_resource(ListResources, '/list_resources', endpoint='list_resources')
ns.add_resource(ReadResource, '/read_resource', endpoint='read_resource')
...
ns.add_resource(QueryConcepts, '/query_concepts', endpoint='post_query_concepts')
ns.add_resource(StoreConcept, '/store_concept', endpoint='post_store_concept')
ns.add_resource(SemanticSearch, '/semantic_search', endpoint='semantic_search')
