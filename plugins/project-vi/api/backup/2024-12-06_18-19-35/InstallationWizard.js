...
const InstallationWizard = () => {
  ...
  useEffect(() => {
    console.log('InstallationWizard mounted');
  ...
  console.log('Rendering InstallationWizard, step:', currentStep);

  return (
    <div className="space-y-8">
      <div className={`${styles.card} bg-concept-brown-dark/10 mb-8`}>
        <h2 className={`text-xl font-bold ${styles.heading}`}>Installation Wizard</h2>
        <p className={styles.subheading}>Let's get your Claude environment set up</p>
      </div>
