      ...
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg">
        ...
        <div className="p-6 border-b border-conceptv-brown-light">
          <div className="flex items-center space-x-3">
            {/* Add ConceptV logo here */}
            <img 
              src="/Icon_ConceptV_VCircle_White.png" 
              alt="ConceptV" 
              className="w-8 h-8"
            />
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="flex items-center">
                            ...
                            {tool.official && (
                              <span className="ml-2 px-2 py-1 text-xs bg-conceptv-yellow-sepia text-conceptv-bg-light rounded">Official</span>
                            )}
                          </div>
                            ...
                            <div>
                              <div className="flex items-center">
                                ...
                                {tool.official ? (
                                  ...
                                  <span className="ml-2 px-2 py-1 text-xs bg-conceptv-brown-light text-conceptv-bg-light rounded">Community</span>
                                )}
                              </div>
                              <p className="text-sm text-conceptv-gray-dark mt-1">{tool.description}</p>
                            </div>
