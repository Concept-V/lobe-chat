...
from .state import VaultState, create_initial_state
from .agents import structure_node, should_continue, STRUCTURE_PROMPT
...
class VaultOrchestrator:
    ...
    def validate_vault(self, scope: str = "all") -> VaultState:
        """Validate the vault's integrity."""
        logger.info(f"Validating vault with scope: {scope}")
        
        # Add operation context
        self.state.operation_context["validation_scope"] = scope
    ...
    def get_vault_status(self) -> Dict:
        ...
        status = {
            ...
            "last_operation": self.state.operation_context.get("operation_type"),
            "health_metrics": {}
        }
